...
periphery --setupFiles "MagicUI.xcodeproj/project.pbxproj" \
  --index-exclude "*/.build/*"
...
- 核心 View 扩展（ExtView+/View+*.swift）
- 基础组件（MagicButton、MagicLoading、MagicKeyValue）
- 公共 API 扩展
- 主要功能模块（Background、Button、Card、KeyValue、Loading）
